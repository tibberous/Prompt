...
$AutoMode = "build-installers"
$AutoLaunchArgs = @("--build", "package", "--offscreen", "--force-rebuild")
$AutoDescription = "build NSIS, Inno, and WiX installers from tested executables"
